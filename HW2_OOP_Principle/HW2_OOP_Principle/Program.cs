...
using HW2_OOP_Principle.Task_3;
...
namespace HW2_OOP_Principle
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // ------------------------------------------------------------
            // Task 2: classes Musical Instruments
            // ------------------------------------------------------------
            ...
            skripka.ShowInfoSkripka();
            trombon.ShowInfoTrombon();
            ukulele.ShowInfoUkulele();
            violenchel.ShowInfoViolenchel();

            // ------------------------------------------------------------
            // Task 3: structure Decimal Number
            // ------------------------------------------------------------

            DecimalNumber decimalNumber = new DecimalNumber(134);

            Console.WriteLine(decimalNumber.ConvertToSystem(2));
            Console.WriteLine(decimalNumber.ConvertToSystem(8));
            Console.WriteLine(decimalNumber.ConvertToSystem(16));
        }
    }
}